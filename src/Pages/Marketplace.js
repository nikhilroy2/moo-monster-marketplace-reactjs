          ...
          <div className="col-12">
            <div className="box_content mb-3 mb-md-5 p-3 p-md-5">
              ...
              <div className="box_content_body flex-wrap flex-md-nowrap flex-column flex-md-row align-items-center d-flex justify-content-between">
                ...
                <div className="box text-white text-center">
                  <strong className="d-block box_title">
                    <img style={{ height: '24px' }} src={require('../Static/img/ic-moo-token.8d1a1ee.png')} alt="img" />
                  </strong>
                  <span className="text_secondary mt-n3 font-weight-bold box_subtitle">
                    $0.0000
                  </span>
              ...
              <div className="items_head mb-3 mb-md-5">
                <div className="items_control d-flex justify-content-between">
                  <div className="items_title">
                    <img style={{ height: '2.5em' }} className="me-3"
                      src={require('../Static/img/icon-item.024ae4c.png')}
                      alt="img" /> <span className="text_secondary">254 Moo - Floor $5.00</span>
                  </div>
                  <div className="items_filter">
                    <div className="d-flex align-items-center justify-content-center">
                      <span className="text-white family_bunny small">Sort by</span>
                      <div className="filter_group ms-3">
                        <select className="select_filter" name="" id="">
                          ...
                          <option value="Token ID (low-high)">Token ID (low-high)</option>
                          <option value="Token ID (high-low)">Token ID (high-low)</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-12 pt-5 pb-3">
                    <nav aria-label="navigation ">
                      <ul className="pagination justify-content-center">
                        <li className="page-item"><a className="page-link paginate_control me-2 text-white prev_disable" href="#"><i className="fas fa-arrow-left    "></i></a></li>
                        <li className="page-item"><a className="page-link me-2 text-white active_link" href="#">1</a></li>
                        <li className="page-item"><a className="page-link me-2 text-white" href="#">2</a></li>
                        <li className="page-item"><a className="page-link me-2 text-white" href="#">3</a></li>
                        <li className="page-item"><a className="page-link me-2 text-white" href="#">4</a></li>
                        <li className="page-item"><a className="page-link me-2 text-white" href="#">5</a></li>
                        <li className="page-item"><a className="page-link paginate_control active_link text-white" href="#"><i className="fas fa-arrow-right    "></i></a></li>
                      </ul>
                    </nav>
                  </div>
                </div>
...
const MarketplaceItemsCard = ({ head_img, head_full_img, head_content_img, head_border, Lv, head_top_svg, rating_svg, name, card_token, busd, count_value }) => {
  return (
    <div id="MarketplaceItemsCard">
      <div className="card_head" style={{
        '--border-color': head_border, background: `url(${head_full_img}) center/100% 100% no-repeat`
      }}>
        <img className="head_img" src={head_img} alt="img" />
        <div className="head_content">
          <div className="content_1 me-2" style={{ 'background': `url(${head_content_img}) center/100% 100% no-repeat` }}>
            <span className="name">
              Lv
            </span>
          ...
          <div className="content_2">
            <div className="content_2_top_svg mb-n3">
              {head_top_svg}
            </div>
            <div className="content_2_rating">
              {rating_svg}
            </div>
          </div>
        </div>
      ...
      <div className="card_body">
        <ul className="list-unstyled p-3 px-4">
          <li className="item_1 d-flex justify-content-between align-items-center">
            <span className="name text_secondary family_bunny">
              {name}
            </span>
          ...
          <li className="item_1 text-white d-flex justify-content-between align-items-center">
            <span className="value">
              <img src={require('../Static/img/ic-busd-token.454c7c3.png')}
                style={{ height: '14px' }} className="me-1" alt="img" /> {busd}
            </span>
